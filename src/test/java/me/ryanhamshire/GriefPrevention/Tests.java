...
public class Tests {
	...
	public void SpamDetector_Padding() {
		SpamDetector detector = new SpamDetector();
		assertFalse(detector.AnalyzeMessage(player1, "Hacking is really fun guys!! :) 123123123456.12398127498762935",
				1000).muteReason != null);
		assertTrue(detector.AnalyzeMessage(player1, "Hacking is really fun guys!! :) 112321523456.1239345498762935",
				1000).muteReason != null);
	}
	...
	public void SpamDetector_TooMuchVolume() {
		SpamDetector detector = new SpamDetector();
		assertFalse(detector.AnalyzeMessage(player1,
		...
		assertFalse(detector.AnalyzeMessage(player1,
				...
				3000).muteReason != null);

		// start of mute
		assertTrue(detector.AnalyzeMessage(player1,
		...
		assertFalse(detector.AnalyzeMessage(player1,
				...
				16000).muteReason != null);
		assertFalse(detector.AnalyzeMessage(player1,
				"When he finally came back, I /SoftMuted him and left him in the jail.", 28000).muteReason != null);
	}

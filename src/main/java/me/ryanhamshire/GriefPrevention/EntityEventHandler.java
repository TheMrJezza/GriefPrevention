...
public class EntityEventHandler implements Listener {
	...
	public void onEntityChangeBLock(EntityChangeBlockEvent event) {
		if (!GriefPrevention.instance.config_endermenMoveBlocks && event.getEntityType() == EntityType.ENDERMAN) {
			...
			event.setCancelled(true);
		} else if (event.getEntityType() == EntityType.WITHER && GriefPrevention.instance.config_claims_worldModes
					...
					if (effected.getType() == EntityType.VILLAGER || effected instanceof Animals) {
						...
						if (claim != null) {
							...
							if (thrower == null || claim.allowContainers(thrower) != null) {
								...
								GriefPrevention.sendMessage(thrower, TextMode.Err, Messages.NoDamageClaimedEntity,
										claim.getOwnerName());
								return;
							}
						}
